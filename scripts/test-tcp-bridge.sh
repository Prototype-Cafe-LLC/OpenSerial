...
if [ "$PLATFORM" == "mac" ]; then
    ...
    echo ""
    echo "5. Share the IP address with Windows user"
    echo ""
else
    echo "Windows Setup Instructions:"
    echo "=========================="
    echo ""
    echo "1. Update configs/client-windows.yaml with Mac's IP address"
    echo ""
...
echo "==============="
echo "- Ensure both machines are on the same network"
